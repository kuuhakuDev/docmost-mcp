...
Gestionar la autenticación del servidor MCP contra Docmost mediante login con email y contraseña, re-login automático ante cookies expiradas, y serialización de logins concurrentes. Todo el proceso es transparente para el LLM.
